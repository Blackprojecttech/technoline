...
# Скрипт исправления развертывания TechnoHub Store на VPS
# Использование: ./fix-vps-deployment.sh
...
echo "🔧 Исправление развертывания TechnoHub Store на VPS"
echo "VPS IP: $VPS_IP"
echo "Домен: $DOMAIN"
echo ""
...
echo "2. Обновление nginx конфигурации..."
