...
const deliveryMethods = [
  ...
  },
  {
    ...
    costPercentage: 5 // 5% от стоимости заказа
  },
  {
    ...
    costPercentage: 8 // 8% от стоимости заказа
  },
  {
    ...
    costPercentage: 15 // 15% от стоимости заказа
  },
  {
    ...
    costPercentage: 10 // 10% от стоимости заказа
  }
];
...
async function addDeliveryMethods() {
  try {
    ...
    createdMethods.forEach((method, index) => {
      const costInfo = method.costPercentage 
        ? `${method.costPercentage}% от заказа`
        : 'Бесплатно';
